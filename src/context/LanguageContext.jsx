...
const translations = {
    en: {
        ...
        explore_desc_dash: "Discover hidden gems",
        agent_desc: "Create your perfect itinerary",
        arts_desc: "Meet local artisans",
        saved_desc: "Your favorite spots",
        trips_desc_dash: "View upcoming journeys",
        maps_desc_dash: "Navigate Mysuru freely",

        // Dashboard Titles
        mysuru_sampada: "Mysuru Sampada",
        dashboard_subtitle: "Unveiling the Hidden Heritage of Mysuru",
        dashboard_tagline: "From Local Hands to Curious Hearts",

        // Settings & Common
        preferences: "Preferences",
        verify_contact_header: "Verify Contact Details",
        otp_sent_to: "We've sent an OTP to your",
        enter_otp_placeholder: "Enter 4-digit OTP",
        verify_action: "Verify",

        // Partner Dashboard
        engagement_week: "Engagement this week",
        visitors: "Visitors",
        total_views: "Total views",
        subscription_plan: "Subscription Plan",
        upgrade_prompt: "Upgrade to PRO for ₹999/month?",
        upgrade_benefit_text: "Upgrade to unlock premium features and visibility.",
        premium_benefit_text: "You are enjoying premium benefits!",
        upgrade_btn_text: "Upgrade to PRO (₹999/mo)",
        pro_benefits: "Pro Benefits",
        benefit_1: "Featured in Search Results",
        benefit_2: "Advanced Analytics Dashboard",
        benefit_3: "Priority Ad Placement",
        benefit_4: "\"Verified Partner\" Badge",
        run_ad_campaign: "Run Ad Campaign",
        ad_content: "Ad Content / Offer",
        ad_content_placeholder: "E.g., Flat 50% OFF on Weekend Stays! Book Now.",
        duration_cost: "Duration & Cost",
        day_1: "1 Day (₹100)",
        days_3: "3 Days (₹250)",
        days_7: "7 Days (₹500)",
        month_1: "1 Month (₹1500)",
        ...
        review_submission: "Review & Edit Submission",
        user_submitted_data: "User Submitted Data",
        add_admin_details: "Add Admin Details (Required)",
        ...
        broadcast_label: "Broadcast Alert",
        ...
        partners_directory: "Partner Directory",
        name: "Name",
        email: "Email",
        phone_number: "Phone Number",
        edit_profile: "Edit Profile",
    ...
    hi: {
        ...
        // User Dashboard Items
        explore_desc_dash: "छिपे हुए रत्नों की खोज करें",
        agent_desc: "अपना सही यात्रा कार्यक्रम बनाएं",
        arts_desc: "स्थानीय कारीगरों से मिलें",
        saved_desc: "आपके पसंदीदा स्थान",
        trips_desc_dash: "आगामी यात्राएं देखें",
        maps_desc_dash: "मैसूरु में आसानी से नेविगेट करें",

        // Dashboard Titles
        mysuru_sampada: "मैसूरु संपदा",
        dashboard_subtitle: "मैसूरु की छिपी हुई विरासत का अनावरण",
        dashboard_tagline: "स्थानीय हाथों से जिज्ञासु दिलों तक",

        // Settings & Common
        preferences: "पसंद",
        verify_contact_header: "संपर्क विवरण सत्यापित करें",
        otp_sent_to: "हमने आपके पास एक ओटीपी भेजा है",
        enter_otp_placeholder: "4-अंकीय ओटीपी दर्ज करें",
        verify_action: "सत्यापित करें",

        // Partner Dashboard
        engagement_week: "इस सप्ताह जुड़ाव",
        visitors: "आगंतुक",
        total_views: "कुल दृश्य",
        subscription_plan: "सदस्यता योजना",
        upgrade_prompt: "₹999/माह के लिए PRO में अपग्रेड करें?",
        upgrade_benefit_text: "प्रीमियम सुविधाओं और दृश्यता को अनलॉक करने के लिए अपग्रेड करें।",
        premium_benefit_text: "आप प्रीमियम लाभों का आनंद ले रहे हैं!",
        upgrade_btn_text: "PRO में अपग्रेड करें (₹999/माह)",
        pro_benefits: "प्रो लाभ",
        benefit_1: "खोज परिणामों में विशेष रुप से प्रदर्शित",
        benefit_2: "उन्नत एनालिटिक्स डैशबोर्ड",
        benefit_3: "प्राथमिकता विज्ञापन प्लेसमेंट",
        benefit_4: "\"सत्यापित भागीदार\" बैज",
        run_ad_campaign: "विज्ञापन अभियान चलाएं",
        ad_content: "विज्ञापन सामग्री / प्रस्ताव",
        ad_content_placeholder: "उदा., सप्ताहांत के लिए 50% छूट! अभी बुक करें।",
        duration_cost: "अवधि और लागत",
        day_1: "1 दिन (₹100)",
        days_3: "3 दिन (₹250)",
        days_7: "7 दिन (₹500)",
        month_1: "1 महीना (₹1500)",
        promote_now: "अब प्रचार करें",
        preview: "पूर्वावलोकन",
        sponsored: "प्रायोजित",
        ...
        new_badge: "नया",
        no_pending: "कोई लंबित सबमिशन नहीं।",
        title: "शीर्षक",
        type: "प्रकार",
        description: "विवरण",
        actions: "कार्रवाई",
        review: "समीक्षा",
        reject: "अस्वीकार",
        approve_publish: "स्वीकृत और प्रकाशित करें",
        review_submission: "समीक्षा और सबमिशन संपादित करें",
        user_submitted_data: "उपयोगकर्ता डेटा",
        add_admin_details: "विवरण जोड़ें (आवश्यक)",
        full_description: "पूर्ण विवरण",
        history: "इतिहास",
        google_maps_url: "गूगल मैप्स URL",
        details: "विवरण",
        contact: "संपर्क",
        status: "स्थिति",
        active: "सक्रिय",
        ...
        broadcast_alert: "ब्रॉडकास्ट अलर्ट",
        broadcast_label: "ब्रॉडकास्ट अलर्ट",
        send_broadcast: "ब्रॉडकास्ट भेजें",

        // Modals
        are_you_sure_logout: "क्या आप वाकई लॉग आउट करना चाहते हैं?",
        are_you_sure_logout: "क्या आप वाकई लॉग आउट करना चाहते हैं?",
        are_you_sure_delete: "क्या आप वाकई अपना खाता हटाना चाहते हैं? यह क्रिया पूर्ववत नहीं की जा सकती।",
    ...
    kn: {
        ...
        // User Dashboard Items
        explore_desc_dash: "ಅಡಗಿರುವ ರತ್ನಗಳನ್ನು ಅನ್ವೇಷಿಸಿ",
        agent_desc: "ನಿಮ್ಮ ಪರಿಪೂರ್ಣ ವಿವರವನ್ನು ರಚಿಸಿ",
        arts_desc: "ಸ್ಥಳೀಯ ಕುಶಲಕರ್ಮಿಗಳನ್ನು ಭೇಟಿ ಮಾಡಿ",
        saved_desc: "ನಿಮ್ಮ ನೆಚ್ಚಿನ ತಾಣಗಳು",
        trips_desc_dash: "ಮುಂಬರುವ ಪ್ರಯಾಣಗಳನ್ನು ವೀಕ್ಷಿಸಿ",
        maps_desc_dash: "ಮೈಸೂರಿನಲ್ಲಿ ಮುಕ್ತವಾಗಿ ಸಂಚರಿಸಿ",

        // Dashboard Titles
        mysuru_sampada: "ಮೈಸೂರು ಸಂಪದ",
        dashboard_subtitle: "ಮೈಸೂರಿನ ಅಡಗಿರುವ ಪರಂಪರೆಯ ಅನಾವರಣ",
        dashboard_tagline: "ಸ್ಥಳೀಯ ಕೈಗಳಿಂದ ಕುತೂಹಲಕಾರಿ ಹೃದಯಗಳಿಗೆ",

        // Settings & Common
        preferences: "ಆದ್ಯತೆಗಳು",
        verify_contact_header: "ಸಂಪರ್ಕ ವಿವರಗಳನ್ನು ಪರಿಶೀಲಿಸಿ",
        otp_sent_to: "ನಾವು ನಿಮ್ಮಗೆ OTP ಕಳುಹಿಸಿದ್ದೇವೆ",
        enter_otp_placeholder: "4-ಅಂಕಿಯ OTP ನಮೂದಿಸಿ",
        verify_action: "ಪರಿಶೀಲಿಸಿ",

        // Partner Dashboard
        engagement_week: "ಈ ವಾರದಲ್ಲಿ ತೊಡಗಿಸಿಕೊಳ್ಳುವಿಕೆ",
        visitors: "ಸಂದರ್ಶಕರು",
        total_views: "ಒಟ್ಟು ವೀಕ್ಷಣೆಗಳು",
        subscription_plan: "ಚಂದಾದಾರಿಕೆ ಯೋಜನೆ",
        upgrade_prompt: "ತಿಂಗಳಿಗೆ ₹999 ಕ್ಕೆ PRO ಗೆ ಅಪ್‌ಗ್ರೇಡ್ ಮಾಡಿ?",
        upgrade_benefit_text: "ಪ್ರೀಮಿಯಂ ವೈಶಿಷ್ಟ್ಯಗಳನ್ನು ಅನ್‌ಲಾಕ್ ಮಾಡಲು ಅಪ್‌ಗ್ರೇಡ್ ಮಾಡಿ.",
        premium_benefit_text: "ನೀವು ಪ್ರೀಮಿಯಂ ಪ್ರಯೋಜನಗಳನ್ನು ಆನಂದಿಸುತ್ತಿದ್ದೀರಿ!",
        upgrade_btn_text: "PRO ಗೆ ಅಪ್‌ಗ್ರೇಡ್ ಮಾಡಿ (₹999/ತಿಂಗಳು)",
        pro_benefits: "ಪ್ರೊ ಪ್ರಯೋಜನಗಳು",
        benefit_1: "ಹುಡುಕಾಟ ಫಲಿತಾಂಶಗಳಲ್ಲಿ ಕಾಣಿಸಿಕೊಳ್ಳುತ್ತದೆ",
        benefit_2: "ಸುಧಾರಿತ ವಿಶ್ಲೇಷಣೆ ಡ್ಯಾಶ್‌ಬೋರ್ಡ್",
        benefit_3: "ಆದ್ಯತೆಯ ಜಾಹೀರಾತು ಪ್ರದರ್ಶನ",
        benefit_4: "\"ಪರಿಶೀಲಿಸಿದ ಪಾಲುದಾರ\" ಬ್ಯಾಡ್ಜ್",
        run_ad_campaign: "ಜಾಹೀರಾತು ಅಭಿಯಾನ ನಡೆಸಿ",
        ad_content: "ಜಾಹೀರಾತು ವಿಷಯ / ಕೊಡುಗೆ",
        ad_content_placeholder: "ಉದಾ, ವಾರಾಂತ್ಯದ ತಂಗುವಿಕೆಗಳಿಗೆ 50% ರಿಯಾಯಿತಿ! ಈಗ ಬುಕ್ ಮಾಡಿ.",
        duration_cost: "ಅವಧಿ ಮತ್ತು ವೆಚ್ಚ",
        day_1: "1 ದಿನ (₹100)",
        days_3: "3 ದಿನಗಳು (₹250)",
        days_7: "7 ದಿನಗಳು (₹500)",
        month_1: "1 ತಿಂಗಳು (₹1500)",
        promote_now: "ಈಗ ಪ್ರಚಾರ ಮಾಡಿ",
        preview: "ಮುನ್ನೋಟ",
        sponsored: "ಪ್ರಾಯೋಜಿತ",

        // Owner Dashboard
        pending_submissions: "ಬಾಕಿ ಉಳಿದಿರುವ ಸಲ್ಲಿಕೆಗಳು",
        new_badge: "ಹೊಸ",
        no_pending: "ಯಾವುದೇ ಸಲ್ಲಿಕೆಗಳು ಬಾಕಿ ಇಲ್ಲ.",
        title: "ಶೀರ್ಷಿಕೆ",
        type: "ಪ್ರಕಾರ",
        description: "ವಿವರಣೆ",
        actions: "ಕ್ರಿಯೆಗಳು",
        review: "ಪರಿಶೀಲಿಸಿ",
        reject: "ತಿರಸ್ಕರಿಸಿ",
        approve_publish: "ಅನುಮೋದಿಸಿ ಮತ್ತು ಪ್ರಕಟಿಸಿ",
        review_submission: "ಪರಿಶೀಲಿಸಿ ಮತ್ತು ಎಡಿಟ್ ಮಾಡಿ",
        user_submitted_data: "ಬಳಕೆದಾರ ಸಲ್ಲಿಸಿದ ಡೇಟಾ",
        add_admin_details: "ವಿವರಗಳನ್ನು ಸೇರಿಸಿ (ಕಡ್ಡಾಯ)",
        full_description: "ಪೂರ್ಣ ವಿವರಣೆ",
        history: "ಇತಿಹಾಸ",
        google_maps_url: "ಗೂಗಲ್ ಮ್ಯಾಪ್ಸ್ URL",
        details: "ವಿವರಗಳು",
        contact: "ಸಂಪರ್ಕ",
        status: "ಸ್ಥಿತಿ",
        active: "ಸಕ್ರಿಯ",
        no_partners: "ಯಾವುದೇ ಪಾಲುದಾರರು ಕಂಡುಬಂದಿಲ್ಲ.",
        no_users: "ಯಾವುದೇ ಬಳಕೆದಾರರು ಕಂಡುಬಂದಿಲ್ಲ.",
        broadcast_alert: "ಬ್ರಾಡ್‌ಕಾಸ್ಟ್ ಅಲರ್ಟ್",
        broadcast_label: "ಬ್ರಾಡ್‌ಕಾಸ್ಟ್ ಅಲರ್ಟ್",
        send_broadcast: "ಬ್ರಾಡ್‌ಕಾಸ್ಟ್ ಕಳುಹಿಸಿ",

        // Modals
        are_you_sure_logout: "ನೀವು ಖಂಡಿತವಾಗಿಯೂ ಲಾಗ್ ಔಟ್ ಮಾಡಲು ಬಯಸುವಿರಾ?",
        are_you_sure_logout: "ನೀವು ಖಂಡಿತವಾಗಿಯೂ ಲಾಗ್ ಔಟ್ ಮಾಡಲು ಬಯಸುವಿರಾ?",
        are_you_sure_delete: "ನಿಮ್ಮ ಖಾತೆಯನ್ನು ಅಳಿಸಲು ನೀವು ಬಯಸುವಿರಾ? ಈ ಕ್ರಿಯೆಯನ್ನು ಹಿಂತಿರುಗಿಸಲು ಸಾಧ್ಯವಿಲ್ಲ.",

        // Missing Keys
        users_directory: "ಬಳಕೆದಾರರ ಪಟ್ಟಿ",
        partners_directory: "ಪಾಲುದಾರರ ಪಟ್ಟಿ",
        name: "ಹೆಸರು",
        email: "ಇಮೇಲ್",
